...
# Set max form memory size at class level - works across all Werkzeug versions
Request.max_form_memory_size = 100 * 1024 * 1024  # 100 MB
...
def init_app():
    ...
    server.config['MAX_FORM_MEMORY_SIZE'] = 100 * 1024 * 1024  # 100 MB
