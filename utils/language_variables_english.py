...
AREA="Area"
PATH="Path planned (Summary)"
PATH_RAW="Path planned (Points)"
...
APA_INDEX="APA Index"
APA_DATA="APA Data"
BATHYMETRY_DATA="Bathymetry Data"
PLANT_VOLUME_DATA="Volume Data"
PLANT_VOLUME="Plant Volume"
CAPACITATED_AOI="Capacitated AOI"
CAPACITATED_PATH="Capacitated Path"

DATA_SITE = {
    "data_description": "Process and retrieve raw data from remote services",
    "bathymetry_description": "Retrieve bathymetry data (lake depth measurements) for a given lake",
    "apa_description": "Retrieve Aquatic Plant Abundance (APA) index raw data for a given lake",
    "plant_volume_description": "Calculate the volume of aquatic plants from APA index and bathymetry data",
    "lake_name": "Lake Name",
    "get_bathymetry": "Get Bathymetry",
    "get_apa": "Get APA Index",
